...
abstract class $SettingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? theme, int? language});
}
...
class _$SettingStateCopyWithImpl<$Res, $Val extends SettingState>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? theme = freezed, Object? language = freezed}) {
    return _then(
      _value.copyWith(
            theme:
                freezed == theme
...
class _$SettingStateImpl implements _SettingState {
  const _$SettingStateImpl({this.theme, this.language});
  ...
  @override
  String toString() {
    return 'SettingState(theme: $theme, language: $language)';
  }
...
abstract class _SettingState implements SettingState {
  const factory _SettingState({final int? theme, final int? language}) =
      _$SettingStateImpl;
