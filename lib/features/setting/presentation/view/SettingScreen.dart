      ...
      body: BlocProvider(
        ...
        child: BlocConsumer<SettingBloc, SettingState>(
          listener: (context, state) {
            if (state.language == 0 && state.language != language) {
              setState(() {
                language = 0;
              });
            }
            if (state.language == 1 && state.language != language) {
              setState(() {
                language = 1;
              });
            }
            if (state.theme == 0 && state.language != language) {
              setState(() {
                theme = 0;
              });
            }
            if (state.theme == 1 && state.language != language) {
              setState(() {
                theme = 1;
              });
            }
